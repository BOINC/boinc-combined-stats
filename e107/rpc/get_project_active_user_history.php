...
print "<title>Project Active User History</title>\n";
...
if ($dbhandle) {
	...
	$query = "select name, active_users from projects where project_id=$project";
	...
	$query = "select * from history_projects_ausers where project_id=$project ";
