...
print "<project_user_count_history>\n";
print "<title>Project User Count History</title>\n";
...
if ($dbhandle) {
	...
	$query = "select name,user_count from projects where project_id=$project";
	...
	$query = "select * from history_projects_users where project_id=$project ";
