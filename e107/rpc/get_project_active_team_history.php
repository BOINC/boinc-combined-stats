...
print "<project_active_team_count_history>\n";
print "<title>Project Active Team History</title>\n";
...
if ($dbhandle) {
	...
	$query = "select name,active_teams from projects where project_id=$project";
	...
	$query = "select * from history_projects_ateams where project_id=$project ";
