...
print "<project_total_credit_history>\n";
print "<title>Project Total Credit History</title>\n";
...
if ($dbhandle) {
	...
	$query = "select name, total_credit from projects where project_id=$project";
	...
	$query = "select * from history_projects_tc where project_id=$project ";
