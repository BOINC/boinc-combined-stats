...
require_once('/home/virtual/netsoft-online.com/home/boinc/db.php');
...
if ($connect != 0)
{
   ...
   $query = "select a.diymap_code, a.country, b.rac from b_country a, b_country_rank b where a.country_id=b.country_id and a.diymap_code is not null order by a.diymap_code";

   $res = mysql_query($query);

   if (!$res) {
     echo "<error>Error performing query: " . mysql_error() . "</error>\n";
     echo "</countrydata>\n";
     exit();
   }
